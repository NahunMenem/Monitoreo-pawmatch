...
export default function MascotasPage() {
  ...
  const fetch = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const res = await getAdminPets(token, {
        page,
        limit: LIMIT,
  ...
  }, [token, page, search, type, sex, provincia]);
    ...
    <div className="space-y-6">
      ...
      <div className="card p-5">
        <div className="flex flex-wrap items-end gap-3">
          ...
          {(search || type || sex || provincia !== ALL_PROVINCES) && (
            <button onClick={() => { setSearch(""); setType(""); setSex(""); setProvincia(ALL_PROVINCES); resetPage(); }}
